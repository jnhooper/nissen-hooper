...
var list=[{body:"This started out as a learning exercise for SVG paths. The only library being used to generate the star is jquery," +
    ...
    header:"<h5>Custom Star <small> -SVG</small></h5>"}];
